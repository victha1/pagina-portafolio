...
const HeroSection = () => {
  const socialIcon = [
    {
      img: "/pagina-portafolio/images/icon/twitter-icon.svg",
      href: "#!",
      icon: "Twitter",
    },
    {
      img: "/pagina-portafolio/images/icon/behance-icon.svg",
      href: "#!",
      icon: "Behance",
    },
    {
      img: "/pagina-portafolio/images/icon/dribble-icon.svg",
      href: "#!",
      icon: "Dribble",
    },
  ];
      ...
      <div className="container">
        <div className="">
          <div className="w-full h-72">
            <Image
              src={"/pagina-portafolio/images/hero-sec/banner-bg-img.png"}
              alt="banner-img"
              width={1080}
              height={267}
          ...
          <div className="border-x border-primary/10">
            <div className="relative flex flex-col xs:flex-row items-center xs:items-start justify-center xs:justify-between max-w-3xl mx-auto gap-10 xs:gap-3 px-4 sm:px-7 pt-22 pb-8 sm:pb-12">
              <div className="absolute top-0 left-0 transform -translate-y-1/2">
                <Image
                  src={"/pagina-portafolio/images/hero-sec/user-img.png"}
                  alt="user-img"
                  width={145}
                  height={145}
              ...
              <div className="flex flex-col gap-2 sm:gap-3 items-center text-center xs:items-start">
                ...
                <div className="flex items-center gap-2">
                  <Image
                    src={"/pagina-portafolio/images/icon/map-icon.svg"}
                    alt="map-icon"
                    width={20}
                    height={20}
                  />
                ...
                <Button asChild className="h-auto rounded-full p-0.5!">
                  ...
                  >
                    <span className="flex items-center gap-3 bg-primary hover:bg-[linear-gradient(96.09deg,_#9282F8_12.17%,_#F3CA4D_90.71%)] py-2.5 px-5 rounded-full">
                      <Image
                        src="/pagina-portafolio/images/icon/spark-icon.svg"
                        alt="spark-icon"
                        width={14}
                        height={14}
                      />
